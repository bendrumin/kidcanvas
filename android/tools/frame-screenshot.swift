#!/usr/bin/env swift
//
// Google Play variant of ios/tools/frame-screenshot.swift, at 1080x2160.
// Play rejects screenshots longer than 2:1, and the emulator captures at
// 1080x2400, so these are framed rather than cropped.
//
// Wraps a raw screenshot in the KidCanvas store frame:
...
let canvasW = 1080, canvasH = 2160

// Card: 90pt margins, top edge at y=432, corners at r=60, clipped by the canvas.
let cardX: CGFloat = 74
let cardTop: CGFloat = 353
let cardW: CGFloat = 933
...
let headlineSize: CGFloat = 75
let headlineBaseline: CGFloat = 184
let subheadSize: CGFloat = 37
let subheadBaseline: CGFloat = 284
