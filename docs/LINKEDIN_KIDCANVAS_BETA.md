...
→ Claude Code as the engineering partner. Not for autocomplete — for the unglamorous work that actually ships products: auditing what my RLS policies really allowed versus what my docs claimed, finding that my contact form had never once worked because my own CSP blocked it, catching a payment bypass before it ever billed anyone.
