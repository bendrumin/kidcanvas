...
→ Delete more than you add. I removed an AI feature that was cooking my CPU for marginal value, and cut a cloud storage provider entirely. Both apps got faster, cheaper, and simpler to reason about.
