...
-- ============================================
-- iOS REVIVAL ADDENDUM (2026-08)
-- Everything below aligns a fresh project with what the iOS app expects.
-- No AI processing anywhere — ai_tags/ai_description are inert columns.
-- ============================================

-- The app treats birth date as optional and stores an avatar color.
...
-- User-written description (was migration 003).
